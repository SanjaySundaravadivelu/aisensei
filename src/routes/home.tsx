...
const HomePage = () => {
  return (
    <div className="flex-col w-full pb-24 hero-container">
      <Container className="">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
			...
			205.333,253.562 205.439,254.706 206.44,255.266 205.386,255.72 		"
                ...
                <g>
                  ...
                  <g>
                    ...
                    <text
                      transform="matrix(0.977 -0.2133 0 1 192.8635 178.0886)"
                      font-family="'Pathway Gothic One'"
                      font-size="15.5752"
                    >
                      E
                  ...
                  <g>
                    ...
                    <text
                      transform="matrix(0.977 -0.2135 0 1 249.5217 225.4861)"
                      font-family="'Pathway Gothic One'"
                      font-size="15.5752"
                    >
                      E
                    ...
                    <text
                      transform="matrix(0.977 -0.2136 0 1 254.5217 224.4861)"
                      font-family="'Pathway Gothic One'"
                      font-size="15.5752"
                    >
                      D
          ...
          <div className="col-span-1 md:col-span-2 gap-8 max-h-86 w-full flex flex-col items-center justify-center text-center">
            <div className="mt-[-80px]">
              ...
              <p className="mt-2 text-muted-foreground text-sm">
                🎤 AI-Powered Mock Interviews Enter your desired role, and our
                AI will generate real-world interview questions. Answer them
                live, receive instant feedback, and refine your responses to
                stand out. <br />
                💼 Smart Job Search & Insights Search for job roles and gain
                valuable insights, including skill roadmaps, salary trends, and
                required qualifications. Plus, get access to real-time job
                postings that match your profile.
              </p>
            </div>
