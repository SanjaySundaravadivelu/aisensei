...
const HomePage = () => {
  return (
    <div className="flex-col w-full pb-24">
      <Container className="py-8 space-y-8 mt-8">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
          ...
          <div className="col-span-1 md:col-span-2 gap-8 max-h-86 min-h-86 w-full flex flex-col items-center justify-center text-center">
